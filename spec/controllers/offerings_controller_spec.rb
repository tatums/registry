  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved offering as @offering" do
        ...
        post :create, {:offering => { "title" => "invalid value" }}, valid_session
        assigns(:offering).should be_a_new(Offering)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested offering" do
        ...
        Offering.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => offering.to_param, :offering => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the offering as @offering" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Offering.any_instance.stub(:save).and_return(false)
        put :update, {:id => offering.to_param, :offering => { "title" => "invalid value" }}, valid_session
        assigns(:offering).should eq(offering)
      end
